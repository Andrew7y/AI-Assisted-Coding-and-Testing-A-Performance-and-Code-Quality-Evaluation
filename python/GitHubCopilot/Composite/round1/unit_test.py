import pytest
from code_1 import Authentication, BalanceInquiry, Withdrawal, Deposit, PinChange, PrintReceipt, ATMComposite, Account

@pytest.fixture
def account():
    return Account(balance=1000, pin="1234")
...
def test_balance_inquiry(account):
    ...
    # Capture the output and assert the expected balance
...
def test_print_receipt():
    ...
    # Capture the output and assert the expected receipt details
